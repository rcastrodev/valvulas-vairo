<div class="modal fade" id="modal-update-element">
    <form action="{{ route('quality.content.updateSlider') }}" method="post" id="form-update-slider" class="modal-dialog" data-info="reset" data-sync="no" enctype="multipart/form-data">
        @csrf
