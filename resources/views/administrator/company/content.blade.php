...
@includeIf('administrator.company.images.create')
@includeIf('administrator.company.images.update') 
@stop
@section('css')
    <meta name="_token" content="{{csrf_token()}}">
    <meta name="url" content="{{route('company.content')}}">
    <meta name="content_find" content="{{route('content')}}">
    <meta name="url2" content="{{ route('company.slider.get-images', ['id'=> $section1->id]) }}">
