<div class="modal fade" id="modal-update-element">
    <form action="{{ route('clients.content.updateInfo') }}" method="post" id="form-update-slider" class="modal-dialog" enctype="multipart/form-data" data-sync="no">
        @csrf
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <small>Tamaño recomendado 234x128px</small>
            </div>      
        </div>
